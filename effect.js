...
$('#turn_on').click(function(){
    // إنشاء عنصر الحاوية لعرض الصورتين والنص في وسط الصفحة
...
$('#play').click(function(){
    ...
    var sentenceDiv = $('<div id="play-sentence" style="position: fixed; top:50%; left:50%; transform: translate(-50%, -50%); font-size: 2em; color: #fff; z-index: 10000; text-align: center;">بمناسبة عيد الحب  <br> كل عيد حب وانتى الحب الاول و الاخير <br></div>');
