...
$(document).ready(function(){
	...
	$('#play').click(function(){
		...
		var sentenceDiv = $('<div id="play-sentence" style="position: fixed; top:50%; left:50%; transform: translate(-50%, -50%); font-size: 0.7em; color: #fff; z-index: 10000; text-align: center;">بمناسبة عيد الحب  <br> كل عيد حب وانتى الحب الاول و الاخير <br></div>');
